# Generated by Django 4.2.8 on 2023-12-19 22:18
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('chat_id', models.CharField(blank=True, max_length=250, null=True, unique=True, verbose_name='id чата')),
                ('role', models.CharField(choices=[('member', 'member')], default='member', max_length=15, verbose_name='роль')),
